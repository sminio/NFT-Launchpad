  ...
  ERC2981Upgradeable
{
  ...
  function initialize(
    ...
    ERC1155Config calldata config_,
    address _receiver
  ...
  function batchMintTo(
    ...
    ERC1155PriceUtils.validateMint(
      invite,
      config,
      auth,
      _minted,
    ...
    ERC1155PriceUtils.updateBalances(
      invite,
      config,
      _ownerBalance,
      _affiliateBalance,
  ...
  function mintTo(
    ...
    ValidationArgs memory args;
    {
      ...
      if (i.randomize) {
        ...
        uint256 seed = ERC1155PriceUtils.random();
        tokenIds = ERC1155PriceUtils.getRandomTokenIds(
          _tokenSupply,
          config.maxSupply,
          i.tokenIds,
          quantity,
  ...
  function withdrawTokens(address[] memory tokens) public {
    ERC1155PriceUtils.withdrawTokens(config, _ownerBalance, _affiliateBalance, owner(), tokens);
  }
