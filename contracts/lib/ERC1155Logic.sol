...
// address constant PLATFORM = 0x898E0a9661f03C6061951cC13d953967263776Ba; // TEST (account[2])
...
library ERC1155PriceUtils {
  ...
  function random() public view returns (uint256) {
    uint256 randomHash = uint256(keccak256(abi.encodePacked(block.prevrandao, block.timestamp)));
    return randomHash;
  }
